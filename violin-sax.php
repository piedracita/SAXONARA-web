...
<head>
    ...
    <!-- CANONICAL -->
    <link rel="canonical" href="https://www.saxonara.com/violin-sax.php">
        ...
        <div class="banner-slider owl-slider" id="banner-slider">
            <div class="banner-item banner-item-violin-sax">
                <div class="banner-content text-white">
                    <div class="container">
                        <h1 class="banner-title">Violín & Saxofón Fusión</h1>
    ...
    <div class="main-wrap">
        ...
        <div class="section section-padding artist-section" id="videos">
            <div class="container">
                ...
                <?php include "common-php/violin-sax/gallery/photos-violin-sax-01-es.html"; ?>
