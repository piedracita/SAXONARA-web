...
<head>
    ...
    <!-- CANONICAL -->
    <link rel="canonical" href="https://www.saxonara.com/onemanband.php">

    <!-- COMMON-LOCALIZATION -->
<!-- REVISAR --> <?php include "common-php/localization/dj-sax.html"; ?>
    <!-- COMMON-LOCALIZATION END -->

    <!-- SITE INFORMATION -->
    <title>One Man Band | Solista para evento cocktail o boda</title>
    <meta name="description" content="La mejor opción musical para un aperitivo de boda con música en directo a guitarra, saxo y voz.">
    <meta name="keywords" content="sax, guitarra, duo, saxo, bodas, coctel, eventos">
        ...
        <div class="banner-slider owl-slider" id="banner-slider">
            <div class="banner-item banner-item-1">
                <div class="banner-content text-white">
                    <div class="container">
                        <h1 class="banner-title">One Man Band</h1>
                        <p class="banner-subtitle"><span class="banner-highlight">La mejor opción musical para un aperitivo de boda con música en directo a guitarra, saxo y voz.</span></p>
                        <div class="button-group">
                            <a class="btn btn-border btn-lg btn-white" href="#contact">Contactar</a>
                            <!-- revisar --> <!-- <a class="btn btn-simple btn-lg btn-white" href="/videos/"><i class="fa-solid fa-play"></i> Ver Vídeos</a> -->
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-xs-12">
                        <div class="section-header text-center style-3">
                            <h3 class="section-title">One Mand Band</h3>
                            <p class="section-subtext">La mejor opción musical para un aperitivo de boda con música en directo a guitarra, saxo y voz.</p>
